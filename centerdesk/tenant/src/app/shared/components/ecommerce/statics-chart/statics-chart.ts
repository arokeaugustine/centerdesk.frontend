...
import { ChartTab } from '../../common/chart-tab/chart-tab';

@Component({
  selector: 'app-statics-chart',
  imports: [NgApexchartsModule, ChartTab],
  templateUrl: './statics-chart.html',
})
export class StatisticsChart implements AfterViewInit {
  ...
  public legend: ApexLegend = { show: false, position: 'top', horizontalAlign: 'left' };
}
